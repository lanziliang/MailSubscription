...
namespace MailSubscription
{
    ...
    ///<param name="e"></param>
    public delegate void WebClientUploadEvent(object sender, MailSubscription.UploadEventArgs e);
    ...
    ///<param name="e"></param>
    public delegate void WebClientDownloadEvent(object sender, MailSubscription.DownloadEventArgs e);
